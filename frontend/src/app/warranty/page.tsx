...
function WarrantyPortalContent() {
  ...
  return (
    <div className="min-h-screen bg-[#F0F9FF] text-slate-800 font-sans antialiased">
      {/* Header Bar */}
      <header className="sticky top-0 z-30 bg-white/90 backdrop-blur-md border-b border-sky-100">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 h-16 flex items-center justify-between">
          <Link href="/" className="flex items-center gap-2.5">
            <div className="flex h-9 w-9 items-center justify-center rounded-xl bg-gradient-to-r from-sky-400 to-blue-500 text-white font-bold shadow-md shadow-sky-400/25">
              <svg
                className="w-5 h-5"
                fill="none"
                stroke="currentColor"
            ...
            <div>
              ...
              <span className="ml-1.5 rounded bg-sky-50 px-1.5 py-0.5 text-[10px] font-bold text-sky-600 border border-sky-200">
                WARRANTY
              </span>
            </div>
          </Link>
          ...
          <div className="flex items-center gap-2">
            <Link
              href="/"
              className="text-xs font-semibold text-slate-600 hover:text-sky-600 px-3 py-1.5 rounded-lg hover:bg-sky-50 transition-colors"
            >
              Dashboard Kasir →
            </Link>
          </div>
      ...
      {/* Hero Search Section */}
      <section className="bg-gradient-to-b from-white via-[#F0F9FF] to-[#E0F2FE]/50 py-10 sm:py-14 border-b border-sky-100 px-4">
        <div className="max-w-2xl mx-auto text-center space-y-4">
          <div className="inline-flex items-center gap-2 rounded-full bg-sky-50 px-3 py-1 text-xs font-semibold text-sky-700 border border-sky-200 shadow-2xs">
          ...
          <p className="text-sm text-slate-600 max-w-lg mx-auto">
            Masukkan 15 digit nomor IMEI perangkat atau nomor nota invoice Anda
            untuk melihat status aktif, tanggal kedaluwarsa, dan syarat klaim
            garansi.
          </p>

          {/* Search Form */}
          <form onSubmit={onFormSubmit} className="pt-2">
            <div className="relative flex items-center shadow-lg rounded-2xl bg-white border border-sky-200/80 focus-within:border-sky-400 focus-within:ring-4 focus-within:ring-sky-400/15 transition-all p-1.5">
              ...
              <button
                ...
                className="rounded-xl bg-gradient-to-r from-sky-400 to-blue-500 hover:from-sky-500 hover:to-blue-600 disabled:opacity-50 text-white font-semibold text-xs px-5 py-3 shadow-md shadow-sky-400/25 transition-all shrink-0 hover:scale-[1.02]"
              >
            ...
            <div className="flex items-center justify-center gap-2 text-[11px] text-slate-500 mt-2.5">
              ...
              <span>
                Ketik{" "}
                <code className="font-mono bg-slate-200 px-1 py-0.5 rounded text-slate-700">
                  *#06#
                </code>{" "}
                di dialer ponsel Anda untuk melihat nomor IMEI.
              </span>
            </div>
          </form>
        </div>
      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 py-8">
        {loading && (
          <div className="p-12 text-center bg-white rounded-3xl border border-sky-100 shadow-sm space-y-3">
            <div className="inline-block h-8 w-8 border-3 border-sky-500 border-t-transparent rounded-full animate-spin"></div>
            <p className="text-sm font-medium text-slate-600">
              Menghubungkan ke database SmartStore ERP...
            </p>
          </div>
        )}
