...
export default function PosCompletedSale({
  ...
  const generateReceiptText = () => {
    ...
    return buildWhatsAppReceiptMessage({
      ...
      items: itemsForWa,
      subtotal:
        parseFloat(receiptPayload?.subtotal || saleResult.subtotal) ||
        grandTotalNum,
      discountTotal:
        parseFloat(receiptPayload?.discountTotal || saleResult.discountTotal) ||
        0,
      taxTotal:
        parseFloat(receiptPayload?.taxTotal || saleResult.taxTotal) || 0,
