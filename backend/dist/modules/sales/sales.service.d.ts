...
export declare class SalesService {
    ...
    constructor(dataSource: DataSource, salesRepo: Repository<Sale>, productsRepo: Repository<Product>, imeiRepo: Repository<ImeiUnit>, customerRepo: Repository<Customer>, pricingService: PricingService);
